...
const HotConcerns = () => {
  return (
    <div className="flex w-full bg-blue-50/60 py-28">
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between w-full">
        ...
        <div className="flex-1 flex justify-end pr-4 lg:pr-28 mb-12">
          <div style={{ height: '400px', position: 'relative' }}>
            ...
            >
              <Card className="p-6 bg-white shadow-lg">
                <h3 className="text-xl font-bold text-gray-800 mb-4">Lorem Ipsum</h3>
